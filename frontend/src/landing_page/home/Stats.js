    ...
    return ( 
        <div className='container p-5'>
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    <img src='media/image/ecosystem.png' style={{width:"75%"}} />
                    <div className='text-center'>
                        <a href='' className='mr-5' style={{textDecoration:"none"}}>Explore our product   <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </a>
